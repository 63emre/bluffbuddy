...
| **4** | **Hedef Yığını Say** | Kontrol edilen yığının tepesinde kaç Kız var? → **2** |
| **5** | **Karar** | Serbest Kart = 4 - 1 - 1 - 2 = 0 → **MÜHÜR!** |
...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│   Serbest_Kart = Toplam - Kilitli - Gömülü - Hedef_Yığındakiler │
│                                                                  │
│   Eğer Serbest_Kart = 0 → Tepedeki rütbe MÜHÜRLENDİ! 🔒        │
│                                                                  │
│   ⚠️ NOT: Hedef_Yığındakiler = Kontrol edilen yığının tepesinde │
│          duran aynı rütbedeki kart sayısı (elde değil!)         │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```

> **🔑 Kodlama Notu:** `SealService.calculateSealStatus()` fonksiyonunda eldeki kartları (`cardsInHands`) çıkarmak YANLIŞTIR! Eldeki kartlar zaten "serbest" kategorisindedir çünkü mühürü kırabilecek anahtarlardır.
